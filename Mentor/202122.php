...
// 2. FETCH DATA FOR 2021/22
// We select only the categories for this specific year
$sql = "SELECT * FROM team_members WHERE category IN ('Senior_2021', 'Junior_2021') ORDER BY display_order ASC";
...
<body>
  ...
  <?php require_once 'includes/header.php'; ?><main id="main" data-aos="fade-in">
    ...
    <div class="breadcrumbs">
      <div class="container">
        <h3>Senior Committee - 2021/22</h3>
    ...
    <section id="trainers" class="trainers">
      <div class="container" data-aos="fade-up">
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
            <?php 
            if(!empty($members['Senior_2021'])) {
                foreach($members['Senior_2021'] as $m) {
                    renderMemberCard($m);
                }
            }
            ?>
    ...
    <div class="breadcrumbs">
      <div class="container">
        <h3>Junior Committee - 2021/22</h3>
    ...
    <section id="trainers" class="trainers">
      <div class="container" data-aos="fade-up">
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
             <?php 
            if(!empty($members['Junior_2021'])) {
                foreach($members['Junior_2021'] as $m) {
                    renderMemberCard($m);
                }
            }
            ?>
