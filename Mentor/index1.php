...
<body>
  ...
  <?php require_once 'includes/header.php'; ?><!-- End Header -->
    ...
    <div class="slider_custom">
        <div class="list">
            <div class="item">
                <img src="../Mentor/assets/img/hero-bg.jpg" alt="image1">
            </div>
            <div class="item">
                <img src="https://live.staticflickr.com/65535/54466957014_7d7e52e57a_o.jpg" alt="image2">
            </div>
            <div class="item">
                <img src="https://i.postimg.cc/cJBFvrsY/office3.jpg" alt="image3">
            </div>
            <div class="item">
                <img src="https://i.postimg.cc/Bvf1dpfc/office4.jpg" alt="image4">
            </div>
            <div class="item">
                <img src="https://i.postimg.cc/bJJYMSr9/office5.jpg" alt="image5">
            </div>
        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              <div class="ratio" style="--bs-aspect-ratio: 66.625%;">
                <img src="https://1.bp.blogspot.com/-CgHbqDC5BDc/Xxk9faCxbXI/AAAAAAAAZ90/wBTaGLz9n847x72UxHRa8zMjUX2MnT8dACLcBGAsYHQ/d/z_p05-sidelined.jpg" class="img-fluid" alt="Responsive Image">
              </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="course-item">
              <img style="height:240px;" src="https://i.ytimg.com/vi/JTvzP7HrMxU/maxresdefault.jpg" class="img-fluid" alt="...">
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4>Exhibition</h4>
                  <p class="price"> </p>
